...
%>
	<form action="modifyOk.jsp" method="post" name="modify_frm" onsubmit="return infoConfirm()">
		<table>
			...
			<tr><th>메일</th><td><input type="email" name="email" value="<%=email==null?"":email%>"></td></tr>
			<tr><th>생년월일</th><td><input type="date" name="tempbirth"
										value="<%=birth!=null?birth.toString().substring(0,10):""%>"></td></tr>
			<tr><th>주소</th><td><input type="text" name="address" value="<%=address==null?"":address%>"></td></tr>
			<tr><td colspan="2">
